...
use Src\Auth\Domain\Exceptions\DeactivatedUserException;
...
final class LoginUseCase {
  ...
  public function __invoke(string $userName, string $password) {
    ...
    $userDeactivated = !$currentUser->is_active;

    if ($userDeactivated) throw new DeactivatedUserException($userNameVO);
